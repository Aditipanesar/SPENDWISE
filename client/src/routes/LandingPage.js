                    ...
                    <div className='text-white w-full pt-20 text-[#fefae0]'>
                        ...
                        <div className='w-full py-5'>
                            <div className='info-container text-left text-[#fefae0]  text-xl text-opacity-80'>
                                <span className='font-semibold text-white'>is an application designed to help individuals or organizations monitor, categorize, and manage their financial transactions. It typically allows users to record income and expenses, analyze spending habits, and maintain a budget.</span> 
                            </div>
                        </div>
